...
public class CommandAboutBattle implements Command{
	...
	public String execute(HttpServletRequest request,
		...
		JsonObject jsonObjectAboutBattle = Json.createObjectBuilder()
			...
			.add(Constants.PARAMETER_TEXT_BATTLE_DESCRIPTION_FULL, battleDescriptionFull)
			.build();
		...
		JsonObject jsonObjectAboutUs = Json.createObjectBuilder()
				...
				.add(Constants.PARAMETER_TEXT_US_DESCRIPTION, aboutbUsDescription)
				.build();
		...
		JsonObject jsonObjectRules = Json.createObjectBuilder()
				...
				.add(Constants.PARAMETER_TEXT_RULES_DESCRIPTION, rulesDescription)
				.build();
		...
		JsonObject jsonObjectInformation = Json.createObjectBuilder()
				...
				.add(Constants.PARAMETER_TEXT_INFO_DESCRIPTION, informationDescription)
				.build();
